...
class ServiceSchema(BaseSchema):
    ...
    def service_permissions(self, service):
        return dao_fetch_service_permissions(service.id)
        # permissions = []
        # str_permissions = []
        ...
        #     }
            # permission = ServicePermission(service_id=service.id, permission=p.permission)
    ...
    def format_as_string_array(self, in_data):
        ...
        #     in_data['permissions'] = [p.permission for p in in_data['permissions']]
        # print(in_data)
        return in_data
